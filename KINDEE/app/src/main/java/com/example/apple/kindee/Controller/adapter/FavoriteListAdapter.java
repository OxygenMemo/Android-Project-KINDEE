...
public class FavoriteListAdapter extends RecyclerView.Adapter<FavoriteListAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            imv = (ImageView) v.findViewById(R.id.Res_img_favoritelist_apadter);
            Res_name = (TextView) v.findViewById(R.id.Res_name_favoritelist_apadter);
            Type_name = (TextView) v.findViewById(R.id.Type_name_favoritelist_apadter);
            cv = v.findViewById(R.id.card_view_favoritelist_apadter);
        }
    }

    // Provide a suitable constructor (depends on the kind of dataset)
    public FavoriteListAdapter(Resturant2[] myDataset,int user_id) {
        mDataset = myDataset;
    ...
    public FavoriteListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View v =  LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_cardview_favoritlist, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        //Log.d("gggg",mDataset[position].Res_name);
